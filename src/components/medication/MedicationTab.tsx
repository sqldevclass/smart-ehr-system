        ...
        {showForm && formData.drug && (
          <div className="relative border-2 border-gray-200 rounded-lg p-4 space-y-3 bg-muted/20">
            ...
            <div className="pr-[26rem]">
              ...
              {dosingInfo && (
                <div className="absolute top-[1px] right-4 w-[32rem] z-10">
                  <div className="rounded-md border border-blue-200 bg-blue-50 p-2.5 pb-1.5 space-y-0.5 text-xs">
                    <p className="font-medium text-blue-800 flex items-center gap-1.5 text-sm">
                    ...
                    {dosingInfo.notes && (
                      <div className="space-y-0.5 border-t border-blue-200 pt-0.5">
                        <span className="text-xs text-blue-600 font-medium">
                          Примечание:
                        </span>
